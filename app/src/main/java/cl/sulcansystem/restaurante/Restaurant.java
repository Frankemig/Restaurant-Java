...
import cl.sulcansystem.restaurante.modelo.ImagenesData;
...
public class Restaurant extends Fragment {
    RecyclerView recycleImagen;
    List<Imagenes> imagenesList = new ArrayList<>();
    ImagenAdapter imagenesAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        imagenesList = ImagenesData.getListaImagenes();
        recycleImagen = view.findViewById(R.id.recycler_restaurant);
        imagenesAdapter = new ImagenAdapter(imagenesList);
        recycleImagen.setAdapter(imagenesAdapter);
    }
}